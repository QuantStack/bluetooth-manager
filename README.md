...
```bash
pip install jupyterlab_web_bluetooth_manager
```
...
```bash
pip uninstall jupyterlab_web_bluetooth_manager
```
...
# Change directory to the jupyterlab_web_bluetooth_manager directory
