...
import arrowUpSVG from '../../../style/arrow-up-with-text.svg';
import arrowDownSVG from '../../../style/arrow-down-with-text.svg';
import turnLeftSVG from '../../../style/turn-left-with-text.svg';
import turnRightSVG from '../../../style/turn-right-with-text.svg';
...
export function ManualControl3({ moveHub }: IMoveHubControlProps) {
  const images = [
    {
      id: 1,
      src: emptySVGUrl,
